...
describe("Adultpop component", () => {
  it("Adultpop should exist", () => {
    const component = render(<Adultpop disableFields={false} room={2} />);
    expect(component).toBeTruthy();
  });

  it("Adultpop select should have name of room1_childpop when given room 1", () => {
    const component = render(<Adultpop disableFields={true} room={1} />);
  ...
  it("Adultpop select should have a value of 2 when local storage of it is 2", () => {
    const obj = {
      room1_adultpop: "2"
    };
  ...
  it("Adultpop select should be abled if disableFields is false", () => {
    const component = render(<Adultpop disableFields={false} room={1} />);
